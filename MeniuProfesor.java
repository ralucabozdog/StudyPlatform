...
public class MeniuProfesor extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MeniuProfesor frame = new MeniuProfesor("Rosca", "Daniela", "1234567890123", "0748239541", "roscadaniela@gmail.com", "Cuca Macaii", "1234567890123456789012345678901234", "b52", "1");
	...
	public MeniuProfesor(String numeUser,
			String prenumeUser,
			String cnpUser,
			String telefonUser,
			String adrEmailUser,
        ...
        JMenuItem mntmNewMenuItem_1_2 = new JMenuItem("Vizualizare catalog");
        ...
        mntmNewMenuItem_1_2.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		...
        		con1.init();
        		con1.vizualizareNoteCurs(idProf, idMaterie);
        		
        		ConexiuneBD con2 = new ConexiuneBD();
        		con2.init();
        		con2.vizualizareNoteMaterie(idProf);
        		
        		ConexiuneBD con3 = new ConexiuneBD();
        		con3.init();
        		con3.vizualizareNoteLaborator(idProf, idMaterie);
        		
        		ConexiuneBD con4 = new ConexiuneBD();
        		con4.init();
        		con4.vizualizareNoteSeminar(idProf, idMaterie);
        		
        		new VizualizareNoteProfesor(idProf).setVisible(true);
        	}
        });
        
        JMenuItem mntmNewMenuItem_1_3_1 = new JMenuItem("Programare activit\u0103\u021Bi");
        mntmNewMenuItem_1_3_1.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		ProgramareActivitati pa = new ProgramareActivitati();
        		pa.setVisible(true);
        	}
        });
        ...
        JMenuItem mntmNewMenuItem_1_4 = new JMenuItem("Impartire procentuala");
        mntmNewMenuItem_1_4.setForeground(new Color(128, 0, 128));
        mntmNewMenuItem_1_4.setFont(new Font("Arial Narrow", Font.BOLD, 14));
        mnNewMenu.add(mntmNewMenuItem_1_4);
        
        mntmNewMenuItem_1_4.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		ImpartireProcentuala ip = new ImpartireProcentuala(1);
        		ip.setVisible(true);
        	}
        });
        ...
        lblNewLabel.setIcon(new ImageIcon("src\\MeniuProfesor.png"));
